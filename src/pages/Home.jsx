...
import { ShoppingBag, LogIn, Leaf, Star, BookOpen, Map, Heart, Shield, Tag, BookMarked, Swords, Sword, ChevronDown, Zap, Clock, Award } from 'lucide-react'
...
const SECTIONS = [
  {
    ...
    cards: [
      ...
      { to: '/specializations',              label: 'Especializaciones', Icon: Award,   desc: 'Afinidad con un tipo de Pokémon'       },
